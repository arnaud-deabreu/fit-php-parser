...
use FitParser\Records\Generated\MonitoringHrData\CurrentDayRestingHeartRate;
use FitParser\Records\Generated\MonitoringHrData\RestingHeartRate;
use FitParser\Records\Generated\MonitoringHrData\Timestamp;
use FitParser\Records\RecordInterface;
use FitParser\Records\UnknownValue;
use FitParser\Records\ValueInterface;

final class MonitoringHrData implements RecordInterface
{
    /** @var ValueInterface[] */
    ...
    public function addValue(ValueInterface $value): void
    {
        if (false === \in_array($value::class, [
            ...
            CurrentDayRestingHeartRate::class,
            UnknownValue::class,
        ], true)) {
